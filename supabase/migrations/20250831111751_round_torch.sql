/*
# Create All DisasterShield Tables

Ensures all required tables are created for the DisasterShield platform.
...
- Comprehensive policies for authenticated access
